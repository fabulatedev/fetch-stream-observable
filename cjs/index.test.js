...
test("fetchObservable json", () => new Promise(done => {
    (0, esm_1.fetchObservable)("http://jsonplaceholder.typicode.com/users/1")
        .subscribe((data) => {
...
test("fetchObservable text", () => new Promise(done => {
    (0, esm_1.fetchObservable)("http://metaphorpsum.com/sentences/1")
        .subscribe((data) => {
        console.log(data, typeof data);
...
test("fetchObservable error", () => new Promise(done => {
    (0, esm_1.fetchObservable)("https://yesno.wtf/ap2")
        .subscribe((data) => {
        done();
    }, err => {
...
test("fetchObservable stream", () => new Promise(done => {
    let totalLen = 0;
    (0, esm_1.fetchObservable)("https://api.openai.com/v1/chat/completions", {
        headers: {
